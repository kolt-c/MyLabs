...
class Computer
{
    ...
    {
        $this->isWorking=True;
        Console::printLine($this->getComputerName() ." is starting..".PHP_EOL,Console::$success);
    }
    ...
    public function printParameters()
    {
        ...
        Console::printLine($result,Console::$warning);
    }

    public function identifyUser()
    {
        Console::printLine($this->getComputerName() . ': Identify by login and password' . PHP_EOL,Console::$success);
    }
